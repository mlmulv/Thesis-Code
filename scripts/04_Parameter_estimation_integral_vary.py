...
def main():
    try:
        SI_ests = np.load("variables/SI_ests_integral_vary_04.npy")
        SI_errs = np.load("variables/SI_errs_integral_vary_04.npy")
        SI_true_arr = np.load("variables/SI_true_arr_integral_vary_04.npy")
        ...
        with open("../config.toml", "rb") as f:
            ...
            print("Done")
            np.save("variables/SI_ests_integral_vary_04", SI_ests)
            np.save("variables/SI_errs_integral_vary_04", SI_errs)
            np.save("variables/SI_true_arr_integral_vary_04", SI_true_arr)
